# Contributing to EdgeX Web UI Golang Project
...
list](https://github.com/phanvanhai/edugroup-ui-go/issues) to determine whether it already includes the
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/edugroup-ui-go.git

   # Navigate to the newly cloned directory
   cd edugroup-ui-go

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/phanvanhai/edugroup-ui-go.git
   ```
